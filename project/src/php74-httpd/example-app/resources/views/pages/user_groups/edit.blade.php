...
@section('content')
  ...
  <div class="container-fluid py-4">
    <div class="row">
      <form action="{{ route('user_group.update', $user_group->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="col-md-12">
          <div class="card">
                ...
                <div class="col-md-6">
                  <div class="d-flex flex-row align-items-center">
                    ...
                    <span class="ms-3 font-weight-bold">
                      Edit User Group (id:{{ $user_group->id }})
                    </span>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input name="name" class="form-control" type="text" value="{{ $user_group->name }}" />
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" rows="10">{{ $user_group->description }}</textarea>
                  </div>
                </div>
              </div>
            </div>
