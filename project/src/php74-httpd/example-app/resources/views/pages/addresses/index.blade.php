...
@section('content')
  @include('layouts.navbars.auth.topnav', ['title' => 'addresses'])
          ...
          <div class="card-header pb-0">
            <div class="d-flex align-items-center justify-content-between">
              <div class="d-flex  align-items-center">
                ...
                <h5 class="ps-2 pt-2">Address list</h5>
              </div>

              <div>
                <a class="btn btn-secondary " href="{{ route('address.create') }}">
                        ...
                        <div class="ms-2 d-flex flex-row justify-content-start align-items-center">
                          ...
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm font-weight-bold">{{ $address->name }}</h6>
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td class="align-middle text-center">
                        <div class="d-flex px-2 py-1 justify-content-center align-items-center">
                          <div class="d-flex text-secondary flex-row justify-content-center" style="gap: 1rem;">
                            <a class="mx-1 btn btn-secondary " href="/addresses/{{ $address->id }}"
                            ...
                            <a class="mx-1 btn btn-secondary "
                              href="{{ route('address.edit', ['address_id' => $address->id]) }}"
                              style="margin-bottom: 0;">
